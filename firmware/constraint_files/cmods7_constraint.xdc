...
## 12 MHz System Clock
set_property -dict { PACKAGE_PIN M9    IOSTANDARD LVCMOS33 } [get_ports { sys_clk_12mhz_i }]; #IO_L13P_T2_MRCC_14 Sch=gclk
create_clock -add -name sys_clk_12mhz_i -period 83.33 -waveform {0 41.66} [get_ports { sys_clk_12mhz_i }];

## Push Buttons
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { sys_rst_i }]; #IO_L6P_T0_34 Sch=btn[0]
set_property -dict { PACKAGE_PIN D1    IOSTANDARD LVCMOS33 } [get_ports { gpio_i }]; #IO_L6N_T0_VREF_34 Sch=btn[1]

## RGB LEDs
set_property -dict { PACKAGE_PIN F1    IOSTANDARD LVCMOS33 } [get_ports { led_blue_n_o }]; #IO_L10N_T1_34 Sch=led0_b
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { led_green_n_o }]; #IO_L9N_T1_DQS_34 Sch=led0_g
set_property -dict { PACKAGE_PIN F2    IOSTANDARD LVCMOS33 } [get_ports { led_red_n_o }]; #IO_L10P_T1_34 Sch=led0_r

## 4 LEDs
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { led_o[0] }]; #IO_L8P_T1_34 Sch=led[1]
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { led_o[1]  }]; #IO_L16P_T2_34 Sch=led[2]
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { led_o[2] }]; #IO_L16N_T2_34 Sch=led[3]
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { led_o[3] }]; #IO_L8N_T1_34 Sch=led[4]

## Top Pmod Header
#set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { ja[0] }]; # Pin 1 #IO_L14P_T2_SRCC_34 Sch=ja[1]
#set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { ja[1] }]; # Pin 2 #IO_L14N_T2_SRCC_34 Sch=ja[2]
#set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { ja[2] }]; # Pin 3 #IO_L13P_T2_MRCC_34 Sch=ja[3]
#set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { ja[3] }]; # Pin 4 #IO_L11N_T1_SRCC_34 Sch=ja[4]
## Bottom Pmod Header
set_property -dict { PACKAGE_PIN H3    IOSTANDARD LVCMOS33 } [get_ports { dac_sync_n_o }]; # Pin 7 #IO_L13N_T2_MRCC_34 Sch=ja[7]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { dac_dina_o }];   # Pin 8 #IO_L12P_T1_MRCC_34 Sch=ja[8]
set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 } [get_ports { dac_dinb_o }];   # Pin 9 #IO_L12N_T1_MRCC_34 Sch=ja[9]
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { dac_sclk_o }];   # Pin 10 #IO_L11P_T1_SRCC_34 Sch=ja[10]

## USB UART
## Note: Port names are from the perspoctive of the FPGA.
set_property -dict { PACKAGE_PIN L12   IOSTANDARD LVCMOS33 } [get_ports { usb_uart_tx_o }]; #IO_L6N_T0_D08_VREF_14 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { usb_uart_rx_i }]; #IO_L5N_T0_D07_14 Sch=uart_txd_in

## Analog Inputs on PIO Pins 32 and 33
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { vaux5p_i }]; #IO_L12P_T1_MRCC_AD5P_15 Sch=ain_p[32]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { vaux5n_i }]; #IO_L12N_T1_MRCC_AD5N_15 Sch=ain_n[32]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { vaux12p_i }]; #IO_L11P_T1_SRCC_AD12P_15 Sch=ain_p[33]
set_property -dict { PACKAGE_PIN A12   IOSTANDARD LVCMOS33 } [get_ports { vaux12n_i }]; #IO_L11N_T1_SRCC_AD12N_15 Sch=ain_n[33]
...
set_property -dict { PACKAGE_PIN B1    IOSTANDARD LVCMOS33 } [get_ports { tone_o }]; # Pin 43 #IO_L4N_T0_34 Sch=pio[43]
...
set_property -dict { PACKAGE_PIN A3    IOSTANDARD LVCMOS33 } [get_ports { rs422_uart_rx_i }]; # Pin 47 #IO_L1N_T0_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN A4    IOSTANDARD LVCMOS33 } [get_ports { rs422_uart_tx_o }]; # Pin 48 #IO_L1P_T0_34 Sch=pio[48]
